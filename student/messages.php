...
<div class="page-header"><div><h1>Messages</h1><p>Communicate with your batches and teachers</p></div></div>
...
<div class="chat-container" style="display:grid;grid-template-columns:300px 1fr;gap:20px;min-height:550px;">
    ...
    <div class="contact-list form-card" style="padding:0;overflow:hidden;display:flex;flex-direction:column;">
        <div style="flex:1;overflow-y:auto;">
            <!-- Groups Section -->
            <div style="padding:14px 16px;background:rgba(0,0,0,0.02);font-size:0.75rem;font-weight:800;text-transform:uppercase;letter-spacing:1px;color:var(--text-secondary);">Groups</div>
            ...
            <p class="empty-msg" style="padding:20px;">No teachers found.</p>
            <?php else: ?>
    ...
    <div class="chat-area form-card" style="padding:0;display:flex;flex-direction:column;">
        ...
        <div style="display:flex;align-items:center;justify-content:center;flex:1;color:var(--text-secondary);flex-direction:column;gap:15px;min-height:450px;">
            ...
            <p style="max-width:300px;text-align:center;">Select a batch group or a teacher from the list to start interacting.</p>
        </div>
        <?php endif; ?>
    </div>
</div>
